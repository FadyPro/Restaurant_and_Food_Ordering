        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 style="width: 150px">Blogs Comments List</h4>
                    <div>
...
{{--                        <a href="{{route('admin.blog-category.create')}}" class="btn btn-primary" style="padding-left: 20px; text-align: right; float: right;">--}}
{{--                            New Item--}}
{{--                        </a>--}}
{{--                    </div>--}}
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($model as $key=>$models)
                                <tr>
                                    ...
                                    <td style="width: 20%">{{$models->blog->title}}</td>
                                    <td>{{$models->user->name}}</td>
                                    <td style="width: 20%">{{$models->comment}}</td>
                                    ...
                                    <td>
                                        @if($models->status === 1)
                                            <a href="javascript:;" wire:click.prevent="changeStatus({{$models->id}})" class="btn btn-success"><i class='fas fa-eye'></i></a>
                                        @else
                                            <a href="javascript:;" wire:click.prevent="changeStatus({{$models->id}})" class="btn btn-warning"><i class='fas fa-eye-slash'></i></a>
                                        @endif
