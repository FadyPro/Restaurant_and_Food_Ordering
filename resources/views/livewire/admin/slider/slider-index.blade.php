        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 style="width: 150px">Slider List</h4>
                    <div>
                    ...
                    <div class="card-header-action" style="padding-left: 20px;" >
                        <a href="{{route('admin.slider.create')}}" class="btn btn-primary" style="padding-left: 20px; text-align: right; float: right;">
                            New Item
                        </a>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{(!empty($models->image))? url('/uploads/slider/'.$models->image) : url('/uploads/no-image.png')}}" class="rounded-circle" width="50" height="50" data-toggle="tooltip" title="" data-original-title="">
                                    </td>
                                    <td>
                                        @if($models->status === 1)
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin/slider/{{$models->id}}/edit"  class="btn btn-primary"><i class='fas fa-edit'></i></a>
