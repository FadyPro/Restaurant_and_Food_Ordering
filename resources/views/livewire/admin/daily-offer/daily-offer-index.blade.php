                        ...
                        <div class="accordion-body collapse" id="panel-body-1" data-parent="#accordion" style="">
                            <form wire:submit.prevent="updateTitles">
                                ...
                                <div class="form-group">
                                    ...
                                    <input wire:model="daily_offer_top_title" type="text" class="form-control" name="daily_offer_top_title"
                                           value="{{ @$titles['daily_offer_top_title'] }}">
                                    @error('daily_offer_top_title') <span class="error">{{ $message }}</span> @enderror
                                </div>
                                <div class="form-group">
                                    <label for="">Main Title</label>
                                    <input wire:model="daily_offer_main_title" type="text" class="form-control" name="daily_offer_main_title"
                                           value="{{ @$titles['daily_offer_main_title'] }}">
                                    @error('daily_offer_main_title') <span class="error">{{ $message }}</span> @enderror
                                </div>
                                <div class="form-group">
                                    <label for="">Sub Title</label>
                                    <input wire:model="daily_offer_sub_title" type="text" class="form-control" name="daily_offer_sub_title"
                                           value="{{ @$titles['daily_offer_sub_title'] }}">
                                    @error('daily_offer_sub_title') <span class="error">{{ $message }}</span> @enderror
                                </div>
        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 style="width: 150px">Daily Offer List</h4>
                    <div>
                    ...
                    <div class="card-header-action" style="padding-left: 20px;" >
                        <a href="{{route('admin.daily-offer.create')}}" class="btn btn-primary" style="padding-left: 20px; text-align: right; float: right;">
                            New Item
                        </a>
                    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($model as $key=>$models)
                                <tr>
                                    ...
                                    <td> <img src="{{(!empty($models->product->thumb_image))? url('/uploads/products/'.$models->product->thumb_image) : url('/uploads/no-image.png')}}"  width="60" height="60"> </td>
                                    ...
                                    <td>
                                        <a href="/admin/daily-offer/{{$models->id}}/edit"  class="btn btn-primary"><i class='fas fa-edit'></i></a>
