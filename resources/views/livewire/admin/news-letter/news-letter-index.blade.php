                ...
                <div id="accordion">
                    <div class="accordion">
                        <div class="accordion-header collapsed bg-primary text-light p-3 " role="button"
                            ...
                            <h4>NewsLetter Message..</h4>
                        </div>
                        <div wire:ignore class="accordion-body collapse" id="panel-body-1" data-parent="#accordion" style="">
                            <form wire:submit="sendNewsLetter">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea wire:model="message" name="message" id="message" class="form-control"></textarea>
        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 style="width: 150px">NewsLetter List</h4>
                    <div>
