                        ...
                        <div class="accordion-body collapse" id="panel-body-1" data-parent="#accordion" style="">
                            <form wire:submit.prevent="updateTitles">
                                ...
                                <div class="form-group">
                                    ...
                                    <input wire:model="why_choose_top_title" type="text" class="form-control" name="why_choose_top_title" value="{{ @$titles['why_choose_top_title'] }}">
                                    @error('why_choose_top_title') <span class="error">{{ $message }}</span> @enderror
                                </div>
                                <div class="form-group">
                                    <label for="">Main Title</label>
                                    <input wire:model="why_choose_main_title" type="text" class="form-control" name="why_choose_main_title" value="{{ @$titles['why_choose_main_title'] }}">
                                    @error('why_choose_main_title') <span class="error">{{ $message }}</span> @enderror
                                </div>
                                <div class="form-group">
                                    <label for="">Sub Title</label>
                                    <input wire:model="why_choose_sub_title" type="text" class="form-control" name="why_choose_sub_title" value="{{ @$titles['why_choose_sub_title'] }}">
                                    @error('why_choose_sub_title') <span class="error">{{ $message }}</span> @enderror
                                </div>
        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 style="width: 150px">why choose us List</h4>
                    <div>
                    ...
                    <div class="card-header-action" style="padding-left: 20px;" >
                        <a href="{{route('admin.why-choose-us.create')}}" class="btn btn-primary" style="padding-left: 20px; text-align: right; float: right;">
                            New Item
                        </a>
                    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($model as $key=>$models)
                                <tr>
                                    ...
                                    <td><i class="{{$models->icon}}"></i>{{$models->icon}}</td>
                                    <td>{{$models->title}}</td>
                                    <td>
                                        @if($models->status === 1)
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin/why-choose-us/{{$models->id}}/edit"  class="btn btn-primary"><i class='fas fa-edit'></i></a>
