        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 style="width: 150px">Banner Slider List</h4>
                    <div>
                    ...
                    <div class="card-header-action" style="padding-left: 20px;" >
                        <a href="{{route('admin.banner-slider.create')}}" class="btn btn-primary" style="padding-left: 20px; text-align: right; float: right;">
                            New Item
                        </a>
                    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($model as $key=>$models)
                                <tr>
                                    ...
                                    <td> <img src="{{(!empty($models->banner))? url('/uploads/banner_slider/'.$models->banner) : url('/uploads/no-image.png')}}"  width="60" height="60"> </td>
                                    <td>{{$models->title}} </td>
                                    <td>{{$models->sub_title}} </td>
                                    <td>{{$models->url}} </td>
                                    <td>
                                        @if($models->status === 1)
                                    ...
                                    <td>
                                        <a href="/admin/banner-slider/{{$models->id}}/edit"  class="btn btn-primary"><i class='fas fa-edit'></i></a>
