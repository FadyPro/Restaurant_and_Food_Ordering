            ...
            <div class="card-body">
                <form wire:submit="save">
                    ...
                    <div class="form-group">
                        ...
                        @else
                            <img src="{{(!empty($BannerSlider->banner))? url('/uploads/banner_slider/'.$BannerSlider->banner) : url('/uploads/no-image.png')}}" style="width: 80px; height: 80px">
                        @endif
                    </div>
                    <div class="form-group">
