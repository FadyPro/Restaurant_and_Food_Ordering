        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 style="width: 150px">Coupon List</h4>
                    <div>
                    ...
                    <div class="card-header-action" style="padding-left: 20px;" >
                        <a href="{{route('admin.coupon.create')}}" class="btn btn-primary" style="padding-left: 20px; text-align: right; float: right;">
                            New Item
                        </a>
                    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($model as $key=>$models)
                                <tr>
                                    ...
                                    <td>{{$models->expire_date}}</td>
                                    <td>{{$models->discount_type}}</td>
                                    ...
                                    <td>
                                        <a href="/admin/coupon/{{$models->id}}/edit"  class="btn btn-primary"><i class='fas fa-edit'></i></a>
