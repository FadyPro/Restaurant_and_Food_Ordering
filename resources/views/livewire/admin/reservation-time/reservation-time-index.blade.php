        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 style="width: 150px">Reservation Times List</h4>
                    <div>
                    ...
                    <div class="card-header-action" style="padding-left: 20px;" >
                        <a href="{{route('admin.reservation-time.create')}}" class="btn btn-primary" style="padding-left: 20px; text-align: right; float: right;">
                            New Item
                        </a>
                    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($model as $key=>$models)
                                <tr>
                                    ...
                                    <td>{{$models->start_time}}</td>
                                    <td>{{$models->end_time}}</td>
                                    <td>
                                        @if($models->status === 1)
                                    ...
                                    <td>
                                        <a href="/admin/reservation-time/{{$models->id}}/edit"  class="btn btn-primary"><i class='fas fa-edit'></i></a>
