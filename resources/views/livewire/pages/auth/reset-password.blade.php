                                ...
                                <input type="hidden" name="token" value="{{ $request->route('token') }}">
                                    <div class="col-xl-12">
                                        <div class="fp__login_imput">
                                            <label>email</label>
                                            <input wire:model="email" type="email" name="email" value="{{ old('email', $request->email) }}" placeholder="Email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="fp__login_imput">
                                            ...
                                            <input wire:model="password_confirmation"  type="password" name="password_confirmation" placeholder="Password">
                                        </div>
                                    </div>
