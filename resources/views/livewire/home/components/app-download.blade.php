<div>
    <section class="fp__download mt_100 xs_mt_70">
        <div class="fp__download_bg" style="background: url({{ '/uploads/'.@$appSection->background }});">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-xl-5 col-md-6 wow fadeInUp" data-wow-duration="1s">
                            <div class="fp__download_img">
                                <img src="{{(!empty(@$appSection->image))? url('/uploads/'.@$appSection->image) : url('/uploads/no-image.png')}}" alt="download" class="img-fluid w-100">
                            </div>
                        </div>
