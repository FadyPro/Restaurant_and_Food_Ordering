            ...
            <form class="fp__search_menu_form mb-4" action="{{ route('blogs') }}" method="GET">
                <div class="row">
                    <div class="col-xl-6 col-md-5">
                        <input wire:model.live="search" type="text" placeholder="Search..." name="search" value="{{ @request()->search }}">
                    </div>
                    <div class="col-xl-6 col-md-6">
                        <select wire:model.live="category" class="nice-select" name="category">
...
{{--                        <a href="{{ route('blogs', ['category' => $category->slug, 'search' => $search]) }}" class="common_btn"> search</a>--}}
