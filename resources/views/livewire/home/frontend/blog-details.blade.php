    ...
    <section class="fp__blog_details mt_120 xs_mt_90 mb_100 xs_mb_70">
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-8">
                    <div class="fp__blog_det_area">
                        <div class="fp__blog_details_img wow fadeInUp" data-wow-duration="1s">
                            <img src="{{(!empty($blog->image))? url('/uploads/blog/'.$blog->image) : url('/uploads/no-image.png')}}"  alt="{{ $blog->title }}" class="img-fluid w-100">
                        </div>
                        ...
                        @if ($nextBlog)
                            <li>
                                <a href="{{ route('blogs.details', $nextBlog->slug) }}">
                                    <img src="{{(!empty($nextBlog->image))? url('/uploads/blog/'.$nextBlog->image) : url('/uploads/no-image.png')}}" alt="button img" class="img-fluid w-100">
                        ...
                        @if ($previousBlog)
                            <li>
                                <a href="{{ route('blogs.details', $previousBlog->slug) }}">
                                    ...
                                    <img src="{{(!empty($previousBlog->image))? url('/uploads/blog/'.$previousBlog->image) : url('/uploads/no-image.png')}}" alt="button img" class="img-fluid w-100">
                                </a>
                            </li>
                        @endif
                    </ul>
                    ...
                    <div class="fp__comment mt_100 xs_mt_70 wow fadeInUp" data-wow-duration="1s">
                        <h4>{{ count($commentAll) }} Comments</h4>
                        @foreach ($commentAll as $comment)
                            <div class="fp__single_comment m-0 border-0">
                                <img src="{{(!empty($comment->user->avatar))? url('/uploads/avatars/'.$comment->user->avatar) : url('/uploads/avatar.png')}}" alt="review" class="img-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="fp__contact_form_input textarea">
                                        ...
                                        <textarea wire:model="comment" rows="5" placeholder="Your Comment" name="comment"></textarea>
                                    </div>
                ...
                <div wire:ignore class="col-xl-4 col-lg-4">
                        ...
                        <div class="fp__related_blog blog_sidebar wow fadeInUp" data-wow-duration="1s">
                            ...
                            <ul>
                                @foreach ($latestBlogs as $latestBlog)
                                    <li>
                                        <img src="{{(!empty($latestBlog->image))? url('/uploads/blog/'.$latestBlog->image) : url('/uploads/no-image.png')}}"  alt="{{ $latestBlog->title }}" class="img-fluid w-100">
                                        <div class="text">
