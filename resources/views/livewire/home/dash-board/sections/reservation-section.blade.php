                    ...
                    <div class="col-xl-3 col-lg-4 wow fadeInUp" data-wow-duration="1s">
                        <div class="fp__dashboard_menu">
                            ...
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <button onclick="window.location='{!! route('reservation-section') !!}'" class="nav-link active" id="v-pills-reservation-tab" data-bs-toggle="pill"
...
{{--                                                        <span class="pending">Approve</span>--}}
{{--                                                    @elseif ($reservation->status === 'complete')--}}
{{--                                                        <span class="complete">Complete</span>--}}
{{--                                                    @elseif ($reservation->status === 'cancel')--}}
{{--                                                        <span class="cancel">Cancel</span>--}}
