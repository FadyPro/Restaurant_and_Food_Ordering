...
<div>
    <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
                    ...
                    @endphp
            @if (auth()->user()->id === 1)
                <li wire:ignore class="dropdown dropdown-list-toggle">
            ...
            <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg notification_beep ">
                    <i class="far fa-bell"></i></a>
                <div class="dropdown-menu dropdown-list dropdown-menu-right">
                    <div class="dropdown-header">Notifications
                        <div class="float-right">
                            <a wire:click="ClearAllNotifications" href="javascript:void(0)">Mark All As Read</a>
                        </div>
                    </div>
            ...
            <li class="dropdown"><a href="#" data-toggle="dropdown"
                    ...
                    <img src="{{asset('uploads/avatars/'.auth()->user()->avatar)}}" class="rounded-circle mr-1">
    ...
    <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="{{ setSidebarActive(['admin.dashboard']) }}"><a class="nav-link" href="/admin/dashboard"><i class="fas fa-fire"></i>
                        Dashboard</a>
                </li>
...
{{--                        <li class="{{ setSidebarActive(['admin.payment-setting.index']) }}" ><a class="nav-link" href="">Payment Gateways</a>--}}
            ...
            'admin.privacy-policy.index',
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setSidebarActive(['admin.terms-and-conditions.index']) }}" ><a class="nav-link" href="{{route('admin.terms-and-conditions.index')}}">Terms and
                            Conditions</a></li>
